...
namespace embree
{
  ...
  RTCIntersectorStream* rtcQueryIntersectorStream(const RTCGeometry* geom, const char* type);

  void rtcDeleteIntersectorStream(RTCIntersectorStream* intersector);
